...
// ==========================================================================
// PR1 Bug Fix Tests â€?positive and negative cases
...
describe('createKnowledgeGraph â€?data integrity for loadServerGraph', () => {
...
describe('loadServerGraph â€?data flow validation', () => {
...
describe('BM25 index â€?argument type validation', () => {
  ...
  // This was the original bug â€?passing graph instead of fileMap
...
describe('highlight clearing â€?state management', () => {
  ...
  it('independent highlight sets can be cleared separately', () => {
    ...
    // Simulate "Turn off all highlights" â€?clear all sets
  ...
  // (selection is a separate state â€?verified by checking they're independent)
  ...
  it('AI highlight toggle does not clear process highlights', () => {
    ...
    // Turn AI on â€?process highlights should survive
    isAIEnabled = true;
    expect(processHighlights.size).toBe(2);
