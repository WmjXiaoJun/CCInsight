...
import { NODE_TABLES, REL_TYPES } from 'ccinsight-shared';
...
//
// Source locations:
//   validLabel / validRelType  -- ccinsight-web/src/core/llm/tools.ts
//   isSafeId                   -- ccinsight-web/src/components/ProcessesPanel.tsx
//   readOnly guard (regex)     -- ccinsight-web/src/core/lbug/lbug-adapter.ts
// ---------------------------------------------------------------------------
...
// validLabel
// ===========================================================================
describe('validLabel â€?NODE_TABLES membership', () => {
...
// validRelType
// ===========================================================================
describe('validRelType â€?REL_TYPES membership', () => {
...
// isSafeId
// ===========================================================================
describe('isSafeId â€?identifier allowlist regex', () => {
  it.each([
...
// ===========================================================================
// readOnly guard â€?write-operation regex
// ===========================================================================
describe('readOnly guard â€?write-operation detection', () => {
