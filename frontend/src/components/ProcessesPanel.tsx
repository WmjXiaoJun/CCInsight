    ...
    return (
      <div className="flex h-full flex-col items-center justify-center p-6 text-center">
        ...
        <p className="max-w-xs text-sm text-text-secondary">
          执行流程是从入口点追踪的代码执行路径。请先加载代码库以查看检测到的执行流程。
        </p>
      </div>
    );
  }
        ...
        <div className="px-4 py-3">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-text-muted">查看 {totalCount} 个执行流程的组合地图</p>
            </div>
            {loadingProcess === 'all' ? (
        ...
        {filteredProcesses.cross.length > 0 && (
          <div className="border-b border-border-subtle">
            ...
            >
              ...
              <span className="text-sm font-medium text-text-primary">跨社区</span>
        ...
        {filteredProcesses.intra.length > 0 && (
          <div>
            ...
            >
              ...
              <span className="text-sm font-medium text-text-primary">社区内</span>
              <span className="ml-auto rounded-full bg-surface px-2 py-0.5 text-xs text-text-muted">
  ...
  return (
    ...
    >
      ...
      <button
        ...
        title={isFocused ? '点击从图谱中移除高亮' : '点击在图谱中高亮显示'}
