...
基于 [GitNexus](https://github.com/CCInsight/gitnexus) 二次开发。核心能力：**对任意代码仓库进行解析与索引，通过知识图谱可视化代码结构，在源码旁叠加双语注解，配合 AI 辅助解读，帮助开发者高效理解复杂代码架构**。
...
CCInsight 是一款源码可视化注解与交互式图谱工具。核心能力：**对任意代码仓库进行解析与索引，通过知识图谱可视化代码结构，在源码旁叠加双语注解，配合 AI 辅助解读，帮助开发者高效理解复杂代码架构**。
