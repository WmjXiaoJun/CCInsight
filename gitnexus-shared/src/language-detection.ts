/**
 * Language Detection â€?maps file paths to SupportedLanguages enum values.
 *
...
/**
 * Exhaustive map: every SupportedLanguages member â†?its file extensions.
 *
...
/** Pre-built reverse lookup: extension â†?language (built once at module load). */
...
/**
 * Exhaustive map: every SupportedLanguages member â†?Prism syntax identifier.
 *
 * If a new language is added to the enum without adding an entry here,
...
/** Non-code file extensions â†?Prism-compatible syntax identifiers */
...
/** Extensionless filenames â†?Prism-compatible syntax identifiers */
