/** Non-generic @call shapes â†?{ calledName, callForm, receiverName? } (used from call-processor / parse-worker). */
...
/** Non-null â†?seed replaces @call.name; null â†?use @call.name + inferCallForm / extractReceiverName. */
