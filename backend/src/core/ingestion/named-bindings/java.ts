...
export function extractJavaNamedBindings(importNode: SyntaxNode): NamedBinding[] | undefined {
  ...
  // Non-static: skip lowercase names â€?those are package imports, not class imports.
  // Static: allow lowercase â€?`import static models.UserFactory.getUser` imports a method.
