// ccinsight/src/core/ingestion/field-extractors/configs/python.ts
...
export const pythonConfig: FieldExtractionConfig = {
  ...
  isStatic(_node) {
    // Reports syntactic static keyword â€?Python class variables don't use explicit static keyword.
