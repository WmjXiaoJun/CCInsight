 ...
 * Unlike extractReceiverName, this returns the receiver node regardless of its type �? * including call_expression / method_invocation nodes that appear in chained calls
