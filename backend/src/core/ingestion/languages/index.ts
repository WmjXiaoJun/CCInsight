/**
 * Language Provider Registry â€?compile-time exhaustive provider table.
 *
...
/** Pre-built extension â†?provider lookup (built once at module load). */
 ...
 *  Built once at module load â€?avoids iterating all 13 providers per call. */
