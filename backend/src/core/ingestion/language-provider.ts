...
import type { SupportedLanguages } from 'ccinsight-shared';
...
interface LanguageProviderConfig {
   ...
   *  function body is a sibling of the signature (e.g. Dart: function_body �?   *  function_signature are siblings under program/class_body), the default
