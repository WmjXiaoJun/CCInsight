...
export function detectFrameworkFromPath(filePath: string): FrameworkHint | null {
  ...
  // Go main.go files (THE entry point) â€?only match main.go, not arbitrary .go files under cmd/
...
export const AST_FRAMEWORK_PATTERNS_BY_LANGUAGE = {
  ...
  [SupportedLanguages.Cobol]: [], // Standalone regex processor â€?no AST framework patterns
