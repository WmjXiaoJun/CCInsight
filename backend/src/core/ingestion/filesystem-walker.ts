...
/** Lightweight entry â€?path + size from stat, no content in memory */
...
/**
 * Phase 1: Scan repository â€?stat files to get paths + sizes, no content loaded.
...
/**
 * Legacy API â€?scans and reads everything into memory.
