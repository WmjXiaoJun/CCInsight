...
import type { GraphNode } from 'ccinsight-shared';
...
// ============================================================================
// CONTENT EXTRACTION (lazy â€?reads from disk on demand)
// ============================================================================
...
/**
 * LRU content cache â€?avoids re-reading the same source file for every
...
class BufferedCSVWriter {
  ...
  constructor(filePath: string, header: string) {
    ...
    // Large repos flush many times â€?raise listener cap to avoid MaxListenersExceededWarning
...
// ============================================================================
// STREAMING CSV GENERATION â€?SINGLE PASS
// ============================================================================
 ...
 * Iterates graph nodes exactly ONCE â€?routes each node to the right writer.
...
export const streamAllCSVsToDisk = async (
  ...
  // Build result map â€?only include tables that have rows
