 ...
 * Analyze Command
 *
 * Indexes a repository and stores the knowledge graph in .ccinsight/
 *
...
export const analyzeCommand = async (inputPath?: string, options?: AnalyzeOptions) => {
  ...
  if (process.env.ccinsight_NO_GITIGNORE) {
    console.log(
      '  ccinsight_NO_GITIGNORE is set �?skipping .gitignore (still reading .ccinsightignore)\n',
    );
  }
  ...
  try {
    ...
    try {
      ...
      console.log('\n  Tip: Run `ccinsight setup` to configure MCP for your editor.');
    }
