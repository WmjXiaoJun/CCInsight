...
describe('isLanguageAvailable', () => {
  ...
  it('handles Swift based on optional dependency availability', () => {
    // Swift is optional â€?result depends on whether tree-sitter-swift is installed
  ...
  it('handles Kotlin based on optional dependency availability', () => {
    // Kotlin is now optional â€?result depends on whether tree-sitter-kotlin is installed
...
describe('Kotlin optional dependency', () => {
  it('handles Kotlin loading gracefully', async () => {
    // Kotlin is optional â€?it either loads successfully or throws an error
    try {
