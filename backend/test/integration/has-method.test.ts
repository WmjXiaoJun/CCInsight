...
describe('HAS_METHOD integration â€?C#: class with interface', () => {
  beforeAll(async () => {
...
`;
    ...
    // findEnclosingClassId returns the interface itself. This is expected â€?    // the pipeline uses defType (definition.interface vs definition.method) to
...
describe('HAS_METHOD integration â€?Rust: impl + trait', () => {
  beforeAll(async () => {
...
describe('HAS_METHOD integration â€?Python: class methods vs standalone functions', () => {
  beforeAll(async () => {
...
describe('HAS_METHOD integration â€?Multiple classes in one file', () => {
  describe('TypeScript', () => {
    beforeAll(async () => {
...
describe('HAS_METHOD integration â€?Java: class with interface', () => {
  beforeAll(async () => {
    await loadLanguage(SupportedLanguages.Java);
  });
...
describe('HAS_METHOD integration â€?C++ class methods', () => {
  beforeAll(async () => {
...
describe('HAS_METHOD integration â€?C# struct and record', () => {
  beforeAll(async () => {
    await loadLanguage(SupportedLanguages.CSharp);
  });
