...
describe('filesystem-walker', () => {
  ...
  describe('.ccinsightignore support', () => {
    ...
    beforeAll(async () => {
      ...
      // Only .ccinsightignore, no .gitignore
      await fs.writeFile(path.join(nexusignoreDir, '.ccinsightignore'), 'local/\n');
    });
    ...
    it('excludes directories listed in .ccinsightignore', async () => {
  ...
  describe('combined .gitignore + .ccinsightignore', () => {
    ...
    beforeAll(async () => {
      ...
      await fs.writeFile(path.join(combinedDir, '.ccinsightignore'), 'local/\n');
    });
  ...
  describe('ccinsight_NO_GITIGNORE env var', () => {
    let envDir: string;
    ...
    it('includes gitignored directory when ccinsight_NO_GITIGNORE is set', async () => {
