...
import { getLanguageFromFilename, SupportedLanguages } from 'ccinsight-shared';
...
describe('parsing', () => {
  ...
  describe('unhappy path', () => {
    ...
    it('handles binary/non-UTF8 content gracefully', async () => {
      ...
      // JavaScript strings are UTF-16 internally, so this is always a valid string �?      // but it exercises tree-sitter's ability to handle unusual byte patterns.
