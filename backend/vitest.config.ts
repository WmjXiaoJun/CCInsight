...
export default defineConfig({
  test: {
    // Shared settings â€?inherited by all projects via extends: true
    ...
    // This is independent of the QueryResult lifetime fix in @ladybugdb/core 0.15.2 â€?    // it's a vitest forks + native addon interaction where destructors run in
    ...
    //
    // Each file runs in its own fork â€?the fork exits after the file
